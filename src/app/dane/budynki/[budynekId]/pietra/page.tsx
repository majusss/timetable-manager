...
import { DeletePietroDialog } from "@/components/dane/pietra/delete-pietro-dialog";
import { EditPietroDialog } from "@/components/dane/pietra/edit-pietro-dialog";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <BackButton href="/dane/budynki" label="Wróć do budynków" />
            ...
            budynek.pietra.map((pietro) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Link
                    href={`/dane/budynki/${budynek.id}/pietra/${pietro.id}/sale`}
                  >
