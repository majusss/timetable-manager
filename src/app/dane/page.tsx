...
import { DangerZone } from "@/components/dane/danger-zone";
import { ImportDialog } from "@/components/dane/import/import-dialog";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <h1 className="text-3xl font-bold mb-8">
        Panel zarządzania danymi szkoły
      </h1>
